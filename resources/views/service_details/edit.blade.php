        ...
        <div class="row-justify-content-center">
            <div class="col-sm-12">
                <div class="card mt-3 p-3">
                    <h3 class="text-muted">Service_details Edit #{{$service_details->id}}</h3>
                    <form method="POST" action="/service_details/{{ $service_details->id }}/update">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="from-group">
                        ...
                        name="service_name"value="{{$service_details->service_name }}"></input>
                    ...
                    <div class="from-group">
                        ...
                        name="description">"{{ $service_details->description }}"</textarea>
                    ...
                    <div class="from-group">
                        ...
                        name="our_plan">"{{ $service_details->our_plan }}"</textarea>
